...
<body
    ...
    x-init="
        applyTheme();
        $watch('miniSidebar', value => localStorage.setItem('miniSidebar', value));
        $watch('theme', value => {
    ...
    <div class="h-screen flex overflow-hidden">
        ...
        >
            ...
            <nav class="flex-1 px-3 py-3 space-y-1 overflow-y-auto">
                <p class="admin-nav-section px-4 text-[11px] font-semibold uppercase tracking-wider mb-2">{{ __('Menu Utama') }}</p>
                ...
                <p class="admin-nav-section px-4 pt-3 text-[11px] font-semibold uppercase tracking-wider mb-2">{{ __('Manajemen') }}</p>
                ...
                <p class="admin-nav-section px-4 pt-3 text-[11px] font-semibold uppercase tracking-wider mb-2">{{ __('Absensi') }}</p>
                ...
                <p class="admin-nav-section px-4 pt-3 text-[11px] font-semibold uppercase tracking-wider mb-2">{{ __('Sistem') }}</p>
            ...
            <div class="admin-user-panel user-box px-4 py-3 border-t">
                <div class="flex items-center gap-3">
                    ...
                    <div class="flex-1 min-w-0 sidebar-text">
                        <p class="admin-sidebar-title text-sm font-medium truncate">{{ Auth::user()->name }}</p>
                        <p class="admin-sidebar-meta text-xs truncate">{{ $primaryRole ? __("roles.{$primaryRole}") : __('User') }}</p>
                    </div>
